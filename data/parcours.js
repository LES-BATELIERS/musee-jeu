...
const PARCOURS = {
  ...
  commun: [
    ...
    // Après cette étape : parcours CLASSIQUE ou PMR
    {
      ...
      indice: {
        ...
        pmr: "Cherche le Putti dans la cour du jardin !"
      }
    }
  ],
  ...
  classique: [
    ...
    // ÉTAPE 6C — La Licorne
    {
      ...
      videoBonneReponse: "https://www.youtube.com/embed/7-Zs-PQM-nQ",
      videsMauvaisesReponses: ["https://www.youtube.com/embed/U94rz744R8s", "https://www.youtube.com/embed/bnnmfyoh2zE"],
      questions: {
        enfant: {
          ...
          bonne: 1,
          messageBonneReponse: "Bien joué ! Suis les panneaux LUMIÈRE DU JOUR vers la cour, au rez-de-chaussée du musée !"
        },
        famille: {
    ...
    // ÉTAPE 5P — Putti Astronome
    {
      ...
      questions: {
        unique: {
          ...
          bonne: 2,
          messageBonneReponse: "Le poisson d'avril n'est pas une blague — c'est le souvenir d'un jour sans nom, hors du temps... Va dans la réserve à carrosses — le Vieux Gardien t'y attend !"
        }
      },
